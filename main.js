...
},{"./frontpage":3,"./hn":5,"./story":7}],2:[function(require,module,exports){
var HN = require('./hn');
...
},{"./hn":5,"./infoline":6}],3:[function(require,module,exports){
var HN = require('./hn');
...
var FrontPage = React.createClass({displayName: "FrontPage",
	...
	render: function() {
		...
		var stories = this.state.topstories.map(function(id) {
			...
			return (
				React.createElement(Headline, {key: id, itemId: id})
			);
		});
...
},{"./headline":4,"./hn":5}],4:[function(require,module,exports){
var HN = require('./hn');
var InfoLine = require('./infoline');
...
},{"./hn":5,"./infoline":6}],5:[function(require,module,exports){
...
},{"./comment":2,"./hn":5,"./infoline":6}],8:[function(require,module,exports){
(function (global){
//! moment.js
//! version : 2.9.0
